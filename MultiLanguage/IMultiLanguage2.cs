...
// Type: MultiLanguage.IMultiLanguage2
...
namespace MultiLanguage
{
  ...
  public interface IMultiLanguage2
  {
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ValidateCodePage([In] uint uiCodePage, [ComAliasName("MultiLanguage.wireHWND"), In] ref _RemotableHandle hwnd);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void ValidateCodePageEx([In] uint uiCodePage, [ComAliasName("MultiLanguage.wireHWND"), In] ref _RemotableHandle hwnd, [In] uint dwfIODControl);
  }
}
